# 🕸️ Chapter 18: Graph Neural Networks (GNNs)

## Project 1: The Core GCN Aggregation (Matrix $\boldsymbol{\tilde{A}}$)

-----

### Definition: The Core GCN Aggregation (Matrix $\boldsymbol{\tilde{A}}$)
...
### Theory: Variable Importance and $\boldsymbol{\alpha_{ij}}$
