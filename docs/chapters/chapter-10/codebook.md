...
## Project 2: Implementing Ridge Regression ($\mathcal{L_2}$ Regularization)

---

### Definition: Implementing Ridge Regression

The goal is to implement the analytical closed-form solution for **Ridge Regression**. We will compare the weights learned with and without the $\mathcal{L_2}$ penalty to demonstrate how the **regularization term** shrinks model complexity.
